...
def load_test_data():
    ...
    df = pd.read_csv('data/output/test_duplicates_injected.csv')
...
def main():
    ...
    #test fuzzy duplicate detection
    fuzzy_detector, fuzzy_precision, fuzzy_recall, fuzzy_f1 = test_fuzzy_duplicate_detection(df, ground_truth, threshold=0.75)
    ...
    print(f"\nFuzzy Duplicate Detection (threshold=0.75):")
